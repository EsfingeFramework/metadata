...
public class MetadataExecute {
	...
	public Object execMetadata(Map<Annotation, AnnotatedElement> repositorio, AnnotatedElement elementWithMetadata) throws Exception {
		...
		System.out.println("METADATA EXECUTE"); 
		...
		System.out.println("Fim MetadataExec");
		return container;
	}
