...
public class ClassMockFieldOfTypeTest {
    public static void main(String[] args) throws NoSuchMethodException, NoSuchFieldException {
        ...
        final Class<? extends Annotation> annotation =  FieldTypeConvention.class;
...
//Creating the class with annotation
        ...
        mockC1.field("id").type(Integer.class).annotation(annotation);
        final Class<?> c1 = mockC1.build();
        System.out.println("result for c1 "+ml.hasMetadata(c1.getField("id"), annotation));
...
//Creating the class without prefix and without annotation
        ...
        System.out.println("result for c2 "+ml.hasMetadata(c2.getField("id"), annotation));
...
//Creating the class with prefix and without annotation
        ...
        System.out.println("result for c3 "+ml.hasMetadata(c3.getField("id"), annotation));
    }
}
