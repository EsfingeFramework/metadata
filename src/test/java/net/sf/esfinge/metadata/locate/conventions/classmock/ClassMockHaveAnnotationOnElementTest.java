...
//Creating the class with prefix and without annotation
        ...
        mockC3.method("setId").returnType(Integer.class).annotation(Override.class);
        final Class<?> c3 = mockC3.build();
        System.out.println(c3.getMethod("setId").getDeclaredAnnotations().length);
        System.out.println("result for c3 "+ml.hasMetadata(c3.getMethod("setId"), Override.class));
    }
}
