...
public class ClassMockHaveAnnotationOnElementTest {
    public static void main(String[] args) throws NoSuchMethodException {
        ...
        final Class<? extends Annotation> annotation =  HaveAnnotationOnElementConvention.class;
...
//Creating the class without prefix and without annotation
        ...
        mockC2.method("setId").parameter("id",Integer.class);
        final Class<?> c2 = mockC2.build();
        System.out.println("result for c2 "+ml.hasMetadata(c2.getMethod("setId",Integer.class), annotation));
