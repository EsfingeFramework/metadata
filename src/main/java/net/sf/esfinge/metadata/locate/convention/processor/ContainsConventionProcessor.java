...
@ConventionXMLTag("contain")
public class ContainsConventionProcessor implements ConventionProcessor{
	...
	public void init(Annotation an) {
		ConventionNameContains cnc = (ConventionNameContains) an;
		name = cnc.contains();
	}
	...
	public void initXML(Map<String, String> attributeMap) {
		name = attributeMap.get("contains");
	}
